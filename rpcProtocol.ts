// from vscode/src/vs/workbench/services/extensions/common/rpcProtocol.ts
// vendored to export more symbols
...
import { RunOnceScheduler } from './vscode/src/vs/base/common/async';
import { VSBuffer } from './vscode/src/vs/base/common/buffer';
import { CancellationToken, CancellationTokenSource } from './vscode/src/vs/base/common/cancellation';
import { CharCode } from './vscode/src/vs/base/common/charCode';
import * as errors from './vscode/src/vs/base/common/errors';
import { Emitter, Event } from './vscode/src/vs/base/common/event';
import { Disposable, DisposableStore, IDisposable } from './vscode/src/vs/base/common/lifecycle';
import { MarshalledObject } from './vscode/src/vs/base/common/marshalling';
import { MarshalledId } from './vscode/src/vs/base/common/marshallingIds';
import { IURITransformer, transformIncomingURIs } from './vscode/src/vs/base/common/uriIpc';
import { IMessagePassingProtocol } from './vscode/src/vs/base/parts/ipc/common/ipc';
import { CanceledLazyPromise, LazyPromise } from './vscode/src/vs/workbench/services/extensions/common/lazyPromise';
import { getStringIdentifierForProxy, IRPCProtocol, Proxied, ProxyIdentifier, SerializableObjectWithBuffers } from './vscode/src/vs/workbench/services/extensions/common/proxyIdentifier';
